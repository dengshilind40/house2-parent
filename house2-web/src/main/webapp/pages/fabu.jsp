...
<BODY>
<center>
  <a href="/getHouseByUser.do" id="href">查看我发布的出租房</a>
</center>
...
<DIV class=box>
<FORM id=add_action method=post name=add.action   enctype="multipart/form-data" action="/addHouse.do">
  <DIV class=infos>
<TABLE class=field>
  <TBODY>
  <TR>
...
<DIV class=buttons><INPUT value=立即发布 type=submit id="sb">
